...
def prxmty_main(southwest_corner,northeast_corner,business_type):


    google_maps_api_key = os.environ.get('API_KEY_P')
    place_types = [business_type] 
    # place_types = ['bar','airport', 'amusement_park', 'aquarium','art_gallery',
